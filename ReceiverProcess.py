...
SID = 3
"""
The receiver only prints the packets that are received
"""
...
class Receiver:
        ...
        while True:
            try:
                ...
                if (segment != None):  ##prevent frames with no QR from being processed
                    ...
                    #check that it is the last frame
    ...
    def processHeader(self, segment):
        ...
        #returns information of header into 4-tuple
...
if self.currentID == None:
    self.currentID = grameID
if self.fterminalFlag...
        """
